...
const STEPS = [
  ...
  },
  {
    ...
    description:
      'Add your API key to start generating test cases. You can change this later in Settings.',
  ...
  },
  {
    ...
    description:
      'Upload a specification document and let AI generate comprehensive test cases instantly.',
