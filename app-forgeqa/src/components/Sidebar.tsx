...
const NAV_ITEMS_BUILD: NavItem[] = [
  { key: "dashboard", label: "Command Center", path: "/dashboard", icon: <DashboardIcon3D size={20} />, color: "violet" },
  { key: "generator", label: "Automation Studio", path: "/generator", icon: <GeneratorIcon3D size={20} />, color: "rose" },
  { key: "test-scripts", label: "Execution Library", path: "/test-scripts", icon: <ScriptsIcon3D size={20} />, color: "emerald" },
  { key: "knowledge", label: "Quality Knowledge Hub", path: "/knowledge", icon: <KnowledgeIcon3D size={20} />, color: "cyan" },
];

const NAV_ITEMS_MONITOR: NavItem[] = [
  { key: "regression", label: "Regression Monitor", path: "/regression", icon: <ShieldIcon3D size={20} />, color: "violet" },
  { key: "analytics", label: "Quality Insights", path: "/analytics", icon: <BarChartIcon3D size={20} />, color: "amber" },
  { key: "suites", label: "Test Collections", path: "/suites", icon: <LayersIcon3D size={20} />, color: "cyan" },
];

const NAV_ITEMS_SYSTEM: NavItem[] = [
  { key: "settings", label: "Workspace Settings", path: "/settings", icon: <SettingsIcon3D size={20} />, color: "amber" },
];
  ...
  return (
    <button 
      ...
      style={{ 
        ...
        boxShadow: active ? "0 4px 16px rgba(37, 99, 235, 0.15), 0 0 0 1px rgba(37, 99, 235, 0.1)" : "none",
    ...
    >
      ...
      <span style={{ 
        ...
        flexShrink: 0,
        color: active ? "#fff" : (item.color === "violet" ? navTokens.accent.violet :
                                 item.color === "rose" ? navTokens.accent.rose :
                                 item.color === "emerald" ? navTokens.accent.emerald :
                                 item.color === "cyan" ? navTokens.accent.cyan :
...
export function Sidebar() {
  ...
  const activeKey = allNavItems.find((i) => location.pathname === i.path)?.key
      ...
      >
        ...
        >
            ...
            >
              <div style={{ 
                ...
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 2l8 3v7c0 4-3.5 7.5-8 9-4.5-1.5-8-5-8-9V5l8-3z" fill="rgba(255,255,255,0.2)" />
              ...
              <div style={{ marginLeft: "0.5rem" }}>
                ...
                <p style={{ 
                  ...
                  margin: 0,
                  marginTop: "0.125rem",
                }}>Enterprise Quality Engineering</p>
              </div>
            </button>
            <button
          ...
          <div className="shrink-0" style={{ padding: "4px 12px 4px" }}>
            <div className={`platform-card ${platformOk ? "platform-card-ok" : "platform-card-warn"}`} style={{ 
              borderRadius: "var(--radius-xl)",
              padding: "0.875rem",
              position: "relative",
              overflow: "hidden",
            }}>
              <div className="platform-card-header" style={{ 
                display: "flex",
                alignItems: "center",
                gap: "0.5rem",
                marginBottom: "0.5rem",
              }}>
                <div className="platform-card-dot" style={{ 
                  width: "8px",
                  height: "8px",
                  position: "relative",
                }}>
                ...
                <span className="platform-card-title" style={{ 
                  fontSize: "0.6875rem",
                  fontWeight: "700",
                  textTransform: "uppercase",
                  letterSpacing: "0.08em",
              ...
              <div className="platform-card-status" style={{ 
                color: "#1E293B",
                fontSize: "0.8125rem",
                fontWeight: "700",
              }}>
              ...
              <div className="platform-card-sub" style={{ 
                color: "#64748B",
                fontSize: "0.6875rem",
                fontWeight: "500",
                marginTop: "0.125rem",
              ...
              {platformOk && (
                <div className="platform-card-progress" style={{ 
                  display: "flex",
                  alignItems: "center",
                  gap: "0.5rem",
                  marginTop: "0.5rem",
                }}>
                  <div className="platform-card-bar" style={{ 
                    flex: 1,
                    height: "3px",
                    borderRadius: "999px",
                    background: "#E2E8F0",
                    ...
                    <div className="platform-card-bar-fill ok" style={{ 
                      height: "100%",
                      borderRadius: "999px",
                  ...
                  <span className="platform-card-pct" style={{ 
                    fontSize: "0.6875rem",
                    fontWeight: "700",
                    color: "#94A3B8",
                    minWidth: "2rem",
