...
const FAQ_ITEMS = [
  ...
  { q: "Which AI provider sees my data?", a: "The provider you choose. When you bring your own API key (BYOK), requests go directly to that provider — ForgeQA never proxies through a shared pool." },
  { q: "Can I bring my own API key?", a: "Yes — every AI provider supports BYOK. Your key is encrypted and stored securely. You can rotate or revoke it at any time from your settings page." },
  ...
  { q: "How does self-healing work?", a: "When a test fails due to UI changes, our AI analyzes the failure, identifies the new selector or wait condition, and automatically updates the test. You review and approve changes via pull request." },
];
...
export default function FaqSection() {
  ...
  return (
    <section id="faq" className="py-20 lg:py-28" style={{ background: "var(--landing-bg-elevated)" }}>
      <div className="max-w-6xl mx-auto px-6 lg:px-10">
        ...
        >
          ...
          <p className="mt-3 text-base max-w-lg" style={{ color: "var(--landing-text-secondary)" }}>
            Everything you need to know about ForgeQA. Can&apos;t find what you&apos;re looking for? Contact our team.
          </p>
        </motion.div>
            ...
            >
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <h3 className="text-lg font-bold mb-3" style={{ color: "var(--landing-text)", fontFamily: "'Space Grotesk', sans-serif" }}>
