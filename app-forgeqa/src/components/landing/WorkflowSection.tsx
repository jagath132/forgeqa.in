...
const STAGES = [
  {
    icon: FileText,
    title: 'Requirements',
    desc: 'Upload PRD, ticket, or plain-text spec',
    color: '#3B82F6',
  },
  {
    icon: Brain,
    title: 'AI Analysis',
    desc: 'NLP extracts intent, edge cases, & acceptance criteria',
    color: '#8B5CF6',
  },
  {
    icon: ListChecks,
    title: 'Generate Tests',
    desc: 'Structured test cases with preconditions & expected results',
    color: '#06B6D4',
  },
  {
    icon: Play,
    title: 'Execute Tests',
    desc: 'Parallel execution across browsers, devices & APIs',
    color: '#22C55E',
  },
  {
    icon: CheckCircle2,
    title: 'Validate Results',
    desc: 'AI-powered diff, visual regression & assertion checks',
    color: '#F59E0B',
  },
  {
    icon: FileBarChart,
    title: 'Generate Reports',
    desc: 'PDF, JUnit XML, CSV, XLSX — direct to CI',
    color: '#F43F5E',
  },
  {
    icon: Rocket,
    title: 'Deploy Confidently',
    desc: 'Ship with verified quality gates & audit trail',
    color: '#3B82F6',
  },
];
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        >
          ...
          >
            Our AI transforms your product requirements into executed, validated, and reported test
            suites — fully automated.
          </p>
        </motion.div>
            ...
            {STAGES.map((stage, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-sm font-bold mb-1" style={{ color: 'var(--landing-text)' }}>
                    {stage.title}
                  </h3>
                  <p
