...
export function LayersIcon3D({ size = 20, className = "" }: Icon3DProps) {
  return (
    <IconContainer size={size} className={className}>
      ...
      <path d="M2 12l10 5 10-5" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" opacity="0.6" />
      <path d="M2 17l10 5 10-5" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" opacity="0.3" />
    </IconContainer>
  );
}
