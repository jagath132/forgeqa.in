...
export function DesktopOnlyGuard({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 text-center animate-fade-in">
      ...
      >
        Test case and test script generation is computationally intensive and requires a desktop or
        laptop browser.
      </p>
      ...
      <div
        className="mt-8 flex items-center gap-2 rounded-lg px-5 py-3 text-sm"
        style={{
