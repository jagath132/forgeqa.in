...
export function SuitesPage() {
  ...
  const activeSuite = useMemo(
    () => suites.find((s) => s.id === selectedSuite),
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>
                  {suite.caseIds.length} cases — {suite.description}
                </p>
              </div>
            </div>
          </button>
        ...
        <Card>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="flex gap-2">
              <button
                onClick={createSuite}
                className="btn-primary px-4 py-2.5 text-sm font-semibold cursor-pointer"
                type="button"
              >
                Create
              </button>
            ...
            <div>
              <div className="flex items-center gap-2.5">
                <span
                  ...
                  style={{ background: activeSuite.color }}
                />
                ...
                return (
                  ...
                  >
                    <input
                      type="checkbox"
                      checked={included}
                      onChange={() => toggleCaseInSuite(tc.tcId)}
