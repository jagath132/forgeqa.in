        ...
        <div>
          ...
          <Card className="p-5 mb-5">
            ...
            <div className="mt-4 flex gap-3">
              <button className="btn-primary px-5 py-2.5 text-sm font-semibold cursor-pointer" type="button" onClick={() => {
                openConfirm("Upgrade Plan", "Plan management is not yet available in the self-hosted version. Contact jagathwork372@gmail.com for enterprise pricing.", () => {}, "Close");
              }}>
                Upgrade Plan
              </button>
          ...
          <Card className="p-5">
            ...
            <div className="flex items-center justify-between rounded-lg p-4" style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-subtle)" }}>
              ...
              <button className="btn-secondary px-4 py-1.5 text-xs font-semibold cursor-pointer" type="button" onClick={() => openConfirm("Payment Method", "Payment method management is not yet available in the self-hosted version. Contact jagathwork372@gmail.com for assistance.", () => {}, "Close")}>Update</button>
            </div>
          </Card>
        </div>
      );
