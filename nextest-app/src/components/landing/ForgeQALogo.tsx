  ...
  return (
    ...
    >
      <svg width={iconSize} height={iconSize} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="1" y="1" width="34" height="34" rx="10" fill="url(#fmark-grad)" fillOpacity="0.12" stroke="url(#fmark-grad)" strokeWidth="1.5" />
        <text x="18" y="24" textAnchor="middle" fill="url(#fmark-grad)" fontFamily="'Space Grotesk','Inter',sans-serif" fontWeight="800" fontSize="20">F</text>
