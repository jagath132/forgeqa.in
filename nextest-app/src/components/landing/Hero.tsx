...
export default function Hero(_props: HeroProps) {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center overflow-hidden" style={{ background: "var(--landing-bg)" }}>
      <div className="particles-grid" />
      <div className="absolute inset-0 pointer-events-none">
        <div className="orb-blue absolute" style={{ width: "60vw", height: "60vw", top: "-20%", left: "-10%", filter: "blur(100px)" }} />
        <div className="orb-violet absolute" style={{ width: "40vw", height: "40vw", bottom: "-10%", right: "-5%", filter: "blur(100px)" }} />
        <div className="orb-cyan absolute" style={{ width: "30vw", height: "30vw", top: "30%", left: "40%", filter: "blur(80px)" }} />
      </div>

      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-10 w-full" style={{ paddingTop: "80px", paddingBottom: "60px" }}>
