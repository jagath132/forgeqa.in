  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Card>
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-xs mt-0.5 max-w-xl" style={{ color: 'var(--text-muted)' }}>
              File uploads save text fields locally. Regenerate embeddings to update prompt-matching
              vector chunks.
            </p>
          </div>
          <button
            className={`px-5 py-2.5 text-sm font-semibold rounded-lg transition-all ${
              canRefreshChunks
                ? 'btn-primary'
                : 'opacity-40 cursor-not-allowed px-5 py-2.5 text-sm font-semibold rounded-lg'
            }`}
        ...
        {needsChunkingCount > 0 ? (
          ...
          >
            ...
            <span>
              {needsChunkingCount} file(s) need chunking. Click refresh to generate embeddings.
            </span>
          </div>
        ) : chunkRefreshNeeded ? (
          <div
          ...
          >
            ...
            <span>
              Files changed since last vectorization. Regenerate chunks to refresh embeddings.
            </span>
          </div>
        ) : showReadyBanner ? (
          <div
          ...
          >
            ...
            <span>
              {files.filter((f) => f.status === 'failed').length} file(s) failed vectorization.
            </span>
          </div>
        ) : null}
      </Card>
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_0.8fr]">
          ...
          <div>
            ...
            <div
              ...
              style={{
                ...
                background: isDragActive ? 'var(--accent-soft)' : 'var(--bg-secondary)',
              }}
            >
              <input {...getInputProps()} />
              <svg
              ...
              <p className="text-xs mt-1" style={{ color: 'var(--text-muted)' }}>
                Text content parses automatically.
              </p>
            </div>
        ...
        <Card className="flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>
              Fetch specification rules from web nodes.
            </p>
      ...
      <Card className="p-0 overflow-hidden">
        <div
          className="flex flex-col gap-3 p-5 sm:flex-row sm:items-center sm:justify-between border-b"
        ...
        >
          <div>
            ...
            <p className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>
              Query status indicators and index variables.
            </p>
          </div>
        ...
        {isLoading ? (
          <div className="space-y-3 p-5">
            {[1, 2, 3].map((item) => (
              <div key={item} className="h-14 shimmer-bg rounded-lg" />
            ))}
          </div>
        ) : files.length ? (
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border-default)' }}>
                  ...
                  <th className="px-5 py-3 text-right" style={{ color: 'var(--text-muted)' }}>
                    Actions
                  </th>
                </tr>
              </thead>
                ...
                {files.map((file) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td
                        className="px-5 py-3.5 text-center font-semibold font-mono"
                        style={{ color: 'var(--text-primary)' }}
                      >
                        {file.chunk_count ?? 0}
                      </td>
          ...
          <div className="p-12 text-center">
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0a2 2 0 01-2 2H6a2 2 0 01-2-2m16 0V9a2 2 0 00-2-2M4 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"
              />
            </svg>
            <p className="text-base font-semibold" style={{ color: 'var(--text-primary)' }}>
              No knowledge source uploaded
            </p>
            <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>
              Upload relevant documents above to feed contexts into the generative pipeline.
            </p>
          </div>
        )}
      </Card>
    ...
    >
      ...
      <div className="relative w-full max-w-sm card p-6 animate-fade-in">
        ...
        <p className="mt-2 text-center text-sm" style={{ color: 'var(--text-muted)' }}>
          Are you sure you want to delete &ldquo;{fileName}&rdquo;? This will remove the file and
          its generated chunks.
        </p>
        <div className="mt-6 flex gap-3">
          ...
          <button
            className="btn-danger flex-1 py-2.5 text-sm font-semibold"
            onClick={onConfirm}
            type="button"
          >
            Delete
