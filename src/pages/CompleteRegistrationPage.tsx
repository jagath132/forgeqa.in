    ...
    <div className="flex min-h-screen" style={{ background: 'var(--paper)' }}>
      ...
      >
        <div className="w-full max-w-sm">
          ...
          {showKeyCard && (
            <div
              className="mb-6 p-5 rounded-xl animate-slide-up text-center"
              style={{
                background:
                  keyStatus === 'invalid' ? 'rgba(239,68,68,0.06)' : 'rgba(47,214,117,0.08)',
            ...
            >
                ...
                style={{
                  background:
                    keyStatus === 'invalid'
                      ? 'rgba(239,68,68,0.12)'
                      : keyStatus === 'valid'
                        ? 'rgba(47,214,117,0.15)'
                        : 'rgba(47,214,117,0.1)',
                }}
              >
                {keyStatus === 'checking' ? (
                  <span
                    className="h-6 w-6 rounded-full border-2 border-transparent border-t-current animate-spin"
              ...
              <p className="text-xs font-mono tracking-widest" style={{ color: 'var(--ink)' }}>
                {productKey}
              </p>
              {keyStatus === 'valid' && (
                <p className="text-xs mt-2" style={{ color: 'var(--graphite)' }}>
                  Key is valid. Click &quot;Activate Account&quot; to complete activation.
                </p>
              )}
              {keyStatus === 'invalid' && (
                <p className="text-xs mt-2" style={{ color: 'var(--graphite)' }}>
                  This key doesn&apos;t exist in our system. Try a different key or contact support.
                </p>
              )}
            </div>
          )}
          ...
          {btnSuccess && (
            ...
            >
              <div
                className="w-full max-w-sm mx-4 p-8 rounded-2xl text-center animate-slide-up"
                style={{ background: 'var(--paper)' }}
              >
                <div
          ...
          {!btnSuccess && (
            <form onSubmit={handleSubmit} autoComplete="off" className="space-y-5">
                ...
                <div className="relative">
                  ...
                  {productKey.length > 0 && (
                    <span className="absolute right-0 top-0 pointer-events-none">
                      {keyStatus === 'checking' ? (
                        <span
                          className="inline-block h-4 w-4 rounded-full border-2 border-transparent border-t-current animate-spin"
                          style={{ color: 'var(--graphite)' }}
                        />
                      ) : keyStatus === 'valid' ? (
                        <svg
              ...
              <button
                type="submit"
                disabled={isLoading || !isValidKey(productKey) || btnSuccess}
      ...
      {supportOpen && (
        ...
        >
          <div
            className="w-full sm:max-w-md bg-white rounded-t-2xl sm:rounded-2xl p-6 animate-slide-up shadow-2xl"
            style={{ background: 'var(--paper)' }}
            ...
            {supportSent ? (
              <div className="text-center py-8">
                <div
                  ...
                  style={{ background: 'rgba(47,214,117,0.12)' }}
                >
                  <svg
                    className="h-7 w-7"
                    fill="none"
