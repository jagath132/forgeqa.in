...
export function RegressionPage() {
  ...
  async function handleGenerate() {
    if (!provider) {
      ...
      setError('Select an AI provider to continue.');
      return;
    }
    if (requirement.trim().length < 10) {
      setError('Requirement text must be at least 10 characters.');
      return;
    }
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {activeStep === 'generate' && (
        <Card>
          ...
          <p className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>
            Describe the new feature or change that requires regression testing.
          </p>
          <div className="mt-4 space-y-3">
            <textarea
              className="input-modern w-full min-h-[160px] resize-none p-4 text-sm leading-relaxed"
            ...
            <div className="flex items-center gap-3">
              <select
                className="input-modern px-3 py-2 text-xs"
                value={platform}
              ...
              <input
                className="input-modern flex-1 px-3 py-2 text-xs"
          ...
          {generatedTestCases.length > 0 && (
            ...
            >
              ...
              <span>
                {generatedTestCases.length} regression test cases generated. Proceed to Step 2.
              </span>
            </div>
          )}
        </Card>
      ...
      {activeStep === 'scripts' && (
        <Card>
          ...
          <p className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>
            Configure script generation for the regression test cases.
          </p>
          <div className="mt-4 space-y-3">
            <div className="flex items-center gap-3">
              <select
            ...
            <p className="text-xs" style={{ color: 'var(--text-muted)' }}>
              {generatedTestCases.length} test case(s) selected for scripting.
            </p>
          </div>
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  className="btn-ghost px-3 py-1 text-xs cursor-pointer"
                  type="button"
                >
                  Copy
                </button>
              ...
              <pre
                className="p-4 text-xs leading-relaxed overflow-x-auto max-h-96"
      ...
      {activeStep === 'execute' && (
        <Card>
          ...
          <p className="text-xs mt-0.5 mb-4" style={{ color: 'var(--text-muted)' }}>
            Run the regression suite and review results.
          </p>
      ...
      {generatedTestCases.length > 0 && (
        <Card>
          <h2 className="text-base font-bold mb-3" style={{ color: 'var(--text-primary)' }}>
            ...
            {generatedSummary && (
              <span style={{ color: 'var(--text-muted)' }}>— {generatedSummary}</span>
            )}
          </h2>
                          ...
                          color:
                            tc.category === 'Positive'
                              ...
                              : tc.category === 'Negative'
                                ? 'var(--accent-rose)'
                                : tc.category === 'Edge' || tc.category === 'Edge cases'
                                  ? 'var(--accent-amber)'
                                  : 'var(--accent-cyan)',
