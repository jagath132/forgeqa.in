    ...
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
      ...
      {message && (
        <div
          ...
          style={{
            background: message.includes('error') ? 'var(--danger-soft)' : 'var(--success-soft)',
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <p className="text-2xl font-bold mt-1">{stats.keyCount}</p>
          </Card>
          <Card>
            <p
              className="text-xs font-semibold uppercase tracking-wider"
            ...
            <p className="text-2xl font-bold mt-1">{stats.usedKeys}</p>
          </Card>
          <Card>
            <p
              className="text-xs font-semibold uppercase tracking-wider"
            ...
            <p className="text-2xl font-bold mt-1">{stats.availableKeys}</p>
          </Card>
      ...
      <div
        ...
        style={{ borderColor: 'var(--border-default)', overflow: 'hidden' }}
      >
              ...
              <tbody>
                {users.map((u) => (
                  <tr key={u.id}>
                    ...
                    <td>
                      <span
                        className={`badge ${u.role === 'Admin' ? 'badge-used' : 'badge-available'}`}
                      >
                        {u.role}
                      </span>
                    </td>
