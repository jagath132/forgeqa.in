...
const SAMPLE_TEST_CASES: TestCase[] = [
  ...
  },
  {
    ...
    testSteps: ['Navigate to Knowledge Base', 'Try to upload a .exe file'],
...
const SAMPLE_KNOWLEDGE_CONTEXT: KnowledgeChunk[] = [
  {
    ...
    chunkText:
      'The /api/auth/login endpoint accepts POST requests with { email, password } and returns a JWT token on success.',
    score: 0.95,
  },
  {
    fileName: 'ui-guidelines.docx',
    chunkText:
      'All form fields must include client-side validation with clear error messages. Password fields must enforce minimum 8 characters.',
    score: 0.88,
  },
  {
    fileName: 'test-strategy.csv',
    chunkText:
      'Regression testing should cover authentication, payment flows, and API integrations before each major release.',
    score: 0.82,
  },
];
...
const SAMPLE_KNOWLEDGE_FILES = [
  {
    id: 'TEST_KF_001',
    file_name: 'login-api-spec.pdf',
    file_type: 'pdf',
    upload_date: '2026-06-28T10:30:00Z',
    source_type: 'upload',
    status: 'ready',
    chunk_count: 12,
  },
  {
    id: 'TEST_KF_002',
    file_name: 'ui-guidelines.docx',
    file_type: 'docx',
    upload_date: '2026-06-29T14:15:00Z',
    source_type: 'upload',
    status: 'ready',
    chunk_count: 8,
  },
  {
    id: 'TEST_KF_003',
    file_name: 'test-strategy.csv',
    file_type: 'csv',
    upload_date: '2026-06-30T09:00:00Z',
    source_type: 'upload',
    status: 'ready',
    chunk_count: 5,
  },
  {
    id: 'TEST_KF_004',
    file_name: 'product-requirements.txt',
    file_type: 'text',
    upload_date: '2026-07-01T11:45:00Z',
  ...
  {
    id: 'TEST_KF_005',
    file_name: 'security-audit.pdf',
    file_type: 'pdf',
    upload_date: '2026-07-02T16:20:00Z',
    source_type: 'upload',
    status: 'ready',
    chunk_count: 15,
  },
  {
    id: 'TEST_KF_006',
    file_name: 'release-notes-v2.docx',
    file_type: 'docx',
    upload_date: '2026-07-03T08:10:00Z',
    source_type: 'upload',
    status: 'processing',
    chunk_count: 0,
  },
...
const SAMPLE_SUITES = [
  ...
  },
  {
    ...
    color: '#8B5CF6',
    caseIds: ['TC_001', 'TC_002', 'TC_003', 'TC_004', 'TC_005', 'TC_006', 'TC_007', 'TC_008'],
  },
  {
    id: 'TEST_SUITE_003',
    name: 'Edge Cases',
    ...
    color: '#F59E0B',
    caseIds: ['TC_004', 'TC_008', 'TC_009', 'TC_012'],
  },
  {
    id: 'TEST_SUITE_004',
    name: 'Security Tests',
    ...
    color: '#10B981',
    caseIds: ['TC_001', 'TC_002', 'TC_006', 'TC_012'],
  },
];
