...
function IconContainer({
  ...
  className = '',
  children,
}: Icon3DProps & { children: React.ReactNode }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ShieldIcon3D({ size = 20, className = '' }: Icon3DProps) {
  return (
    <IconContainer size={size} className={className}>
      <path
...
export function BarChartIcon3D({ size = 20, className = '' }: Icon3DProps) {
  return (
    <IconContainer size={size} className={className}>
      <rect x="4" y="14" width="4" height="6" rx="0.5" fill="currentColor" opacity="0.2" />
      <rect x="4" y="14" width="4" height="6" rx="0.5" stroke="currentColor" strokeWidth="1.5" />
      <rect x="10" y="9" width="4" height="11" rx="0.5" fill="currentColor" opacity="0.3" />
      <rect x="10" y="9" width="4" height="11" rx="0.5" stroke="currentColor" strokeWidth="1.5" />
      <rect x="16" y="4" width="4" height="16" rx="0.5" fill="currentColor" opacity="0.25" />
      <rect x="16" y="4" width="4" height="16" rx="0.5" stroke="currentColor" strokeWidth="1.5" />
    </IconContainer>
  );
}

export function LayersIcon3D({ size = 20, className = '' }: Icon3DProps) {
  return (
    <IconContainer size={size} className={className}>
...
export function ChevronLeftIcon3D({ size = 12, className = '' }: Icon3DProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ChevronRightIcon3D({ size = 12, className = '' }: Icon3DProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LogOutIcon3D({ size = 14, className = '' }: Icon3DProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FeatureIcon3D({
  ...
  type: 'knowledge' | 'ai' | 'code' | 'export' | 'shield' | 'history' | 'cube' | 'sparkle';
}) {
  const iconMap: Record<string, React.ReactNode> = {
    ...
    sparkle: (
      <>
        ...
        <path
          d="M18 6l-1 2M6 18l-1 2M18 18l-2-1M6 6l-2-1"
          stroke="currentColor"
          strokeWidth="1"
          strokeLinecap="round"
          opacity="0.3"
