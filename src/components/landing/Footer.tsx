    ...
    >
      <div
        style={{
          height: 1,
          background:
            'linear-gradient(90deg, transparent, var(--neon-blue), var(--neon-cyan), var(--neon-violet), transparent)',
          opacity: 0.2,
        }}
      />
      ...
      >
        <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
          <div className="lg:col-span-2 space-y-4">
            ...
            >
              AI-powered test automation platform. Generate, execute, and manage automated test
              suites across web, mobile, API, and desktop — all from one unified dashboard.
            </p>
        ...
        <div
          className="flex flex-wrap items-center justify-center gap-6 py-6 mt-8"
